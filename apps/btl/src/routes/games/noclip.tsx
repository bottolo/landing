...
function RouteComponent() {
	...
	return (
		<div className={"flex flex-col items-center"}>
			<div className={"absolute top-2 flex flex-col items-center z-[5]"}>
			...
			<div
				className={cn(
					"absolute flex flex-col items-center gap-8 top-24 opacity-20 h-[90vh] w-[300px] md:w-[700px] overflow-hidden scale-80",
			...
			<div
				className={cn(
					"absolute flex flex-col items-center w-[250px] md:w-[450px] text-center text-2xl/14 h-[90vh] gap-[15rem] top-24 overflow-hidden scale-80",
					view === "text" && "overflow-y-auto z-[1] scale-100",
				)}
			>
				<p>
